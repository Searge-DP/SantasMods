...
public class EntityNetherStarBlast extends EntityThrowable {
    ...
    public EntityNetherStarBlast(World par1){
        super(par1);
        this.setSize(0.25F, 0.25F);
    }

    public EntityNetherStarBlast(World par1, EntityPlayer par3EntityPlayer){
        super(par1, par3EntityPlayer);
    }

    public EntityNetherStarBlast(World par1, double par2, double par3, double par4){
