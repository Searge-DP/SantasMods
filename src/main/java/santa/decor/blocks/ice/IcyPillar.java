 ...
 */
public class IcyPillar extends BlockRotatedPillar {
    ...
    public IcyPillar(){
        super(Material.rock);
        this.setBlockName(BlockInfo.ICEPILLAR_UNLOCALIZED_NAME);
    ...
    public void registerBlockIcons(IIconRegister icon){
        endIcon = icon.registerIcon("santasdecor:icypillartop");

        sideIcon = icon.registerIcon("santasdecor:icypillar");
    }
