 ...
 */
public class SlimyLog extends BlockRotatedPillar {
    ...
    public SlimyLog(){
        super(Material.wood);
        this.setBlockName(BlockInfo.SLIMELOG_UNLOCALIZED_NAME);
    ...
    public void registerBlockIcons(IIconRegister icon){
        endIcon = icon.registerIcon("santasdecor:slimylogtop");

        sideIcon = icon.registerIcon("santasdecor:slimylog");
    }
