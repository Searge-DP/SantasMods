...
public class Fluids implements Runnable{
    ...
    public void run(){
        ...
        GT_Mod.gregtechproxy.addFluid("potion.liqueurOrange", "Orange Liqueur", null, 1, 295, FoodList.Orange_Liqueur.get(1L, new Object[0]), ItemList.Bottle_Empty.get(1L, new Object[0]), 250);
        ...
        GT_Mod.gregtechproxy.addFluid("potion.juicePear", "Pear Juice", null, 1, 295, FoodList.Pear_Juice.get(1L, new Object[0]), ItemList.Bottle_Empty.get(1L, new Object[0]), 250);
        GT_Mod.gregtechproxy.addFluid("potion.appleberry", "Apple-Berry Juice", null, 1, 295, FoodList.Apple_Berry_Juice.get(1L, new Object[0]), ItemList.Bottle_Empty.get(1L, new Object[0]), 250);
    }
}
