...
public class MetaItem extends GT_MetaGenerated_Item{
    ...
    public MetaItem() {
        ...
        FoodList.Irish_Coffee.set(addItem(lastID = 18, "Irish Coffee", "Just the regular morning Coffee... I swear", new Object[]{ new GT_FoodStat(3, 0.4F, EnumAction.drink, ItemList.Bottle_Empty.get(1L, new Object[0]), GregTech_API.sDrinksAlwaysDrinkable, false, false, new int[]{ Potion.confusion.id, 400, 1, 60, Potion.moveSpeed.id, 400, 1, 700, Potion.digSpeed.id, 400, 1, 70, Potion.poison.id, 200, 0, 30 })}));
        FoodList.Brandy_Coffee.set(addItem(lastID = 19, "Brandy Coffee", "Just the regular morning Coffee... I swear", new Object[]{ new GT_FoodStat(3, 0.4F, EnumAction.drink, ItemList.Bottle_Empty.get(1L, new Object[0]), GregTech_API.sDrinksAlwaysDrinkable, false, false, new int[]{ Potion.confusion.id, 400, 1, 10, Potion.poison.id, 200, 0, 10, Potion.resistance.id, 400, 0, 30, Potion.moveSpeed.id, 400, 1, 70, Potion.digSpeed.id, 400, 1, 70 })}));
        FoodList.English_Coffee.set(addItem(lastID = 20, "English Coffee", "Just the regular morning Coffee... I swear", new Object[]{ new GT_FoodStat(3, 0.4F, EnumAction.drink, ItemList.Bottle_Empty.get(1L, new Object[0]), GregTech_API.sDrinksAlwaysDrinkable, false, false, new int[]{ Potion.confusion.id, 500, 0, 60, Potion.damageBoost.id, 500, 1, 60, Potion.poison.id, 200, 1, 5, Potion.moveSpeed.id, 400, 1, 700, Potion.digSpeed.id, 400, 1, 70 })}));
        FoodList.Shin_Shin_Coffee.set(addItem(lastID = 21, "Shin Shin Coffee", "Just the regular morning Coffee... I swear", new Object[]{ new GT_FoodStat(3, 0.4F, EnumAction.drink, ItemList.Bottle_Empty.get(1L, new Object[0]), GregTech_API.sDrinksAlwaysDrinkable, false, false, new int[]{ Potion.confusion.id, 300, 0, 60, Potion.damageBoost.id, 300, 1, 60, Potion.poison.id, 200, 1, 5, Potion.moveSpeed.id, 400, 1, 700, Potion.digSpeed.id, 400, 1, 70 })}));
        FoodList.Russian_Coffee.set(addItem(lastID = 22, "Russian Coffee", "Just the regular morning Coffee... I swear", new Object[]{ new GT_FoodStat(3, 0.4F, EnumAction.drink, ItemList.Bottle_Empty.get(1L, new Object[0]), GregTech_API.sDrinksAlwaysDrinkable, false, false, new int[]{ Potion.confusion.id, 600, 1, 75, Potion.damageBoost.id, 300, 0, 15, Potion.poison.id, 200, 0, 10, Potion.moveSpeed.id, 400, 1, 70, Potion.digSpeed.id, 400, 1, 70})}));
